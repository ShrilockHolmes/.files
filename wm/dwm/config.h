...
static Key keys[] = {
    ...
    // { MODKEY|ShiftMask,             XK_j,                      movestack, {.i
    // = +1 } }, { MODKEY|ShiftMask,             XK_l, movestack,      {.i = +1
    // } }, { MODKEY|ShiftMask,             XK_h, movestack,      {.i = -1 } },
    //{ MODKEY|ShiftMask,             XK_k,                      movestack, {.i
    //= -1 } },
    ...
    //= &layouts[0]} }, { MODKEY,                       XK_v, setlayout, {.v =
    //&layouts[1]} }, { MODKEY,                       XK_f, setfullscreen, {0}
    //},
    {MODKEY | ShiftMask, XK_space, togglefloating, {0}},
    //{ MODKEY,                       XK_0,                      view, {.ui = ~0
    //} }, { MODKEY,                       XK_comma,                  focusmon,
    //{.i = -1 } }, { MODKEY,                       XK_period, focusmon, {.i =
    //+1 } }, { MODKEY|ShiftMask,             XK_comma,                  tagmon,
    //{.i = -1 } }, { MODKEY|ShiftMask,             XK_period, tagmon, {.i = +1
    //} },
